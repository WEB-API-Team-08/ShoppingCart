...
const LikeButton = ({ id, likeCount }) => {
    ...
    const like = async (id) => {
        await axios.put(`http://localhost:5000/api/items/like/${id}`)
            .then(res => {
                setLiked(true);
                setNewlikeCount(res.data.likeCount);
    ...
    const unlike = async (id) => {
        await axios.put(`http://localhost:5000/api/items/unlike/${id}`)
            .then(res => {
                setLiked(false);
                setNewlikeCount(res.data.likeCount);
    ...
    return (
        <React.Fragment>
            ...
            <label style={{ padding: "10px" }}>{newlikeCount} likes</label>
        </React.Fragment>
    )
}
